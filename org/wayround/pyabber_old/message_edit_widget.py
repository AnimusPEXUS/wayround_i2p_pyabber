...
class AddModeLang:
    ...
    def __init__(self, mode='message'):
        ...
        mode_switch_combo.set_model(org.wayround.pyabber.l10n.MODE_LIST)
    ...
    def _combo_get_active(self):
        ...
        if res != -1:
            ret = org.wayround.pyabber.l10n.MODE_LIST[res][0]
    ...
    def get_mode_lang_switch_status(self):
        ...
        if active != -1:
            ...
            if self._mode == 'message':
                ...
                res = org.wayround.pyabber.l10n.LANG_RE.match(active_text)
                if res != None:
                    lang = res.group('lang')
                    if lang == None:
                        lang = ''
