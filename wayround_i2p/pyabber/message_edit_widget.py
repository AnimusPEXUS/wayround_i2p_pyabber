...
class AddModeLang:
    ...
    def __init__(self, mode='message'):
        ...
        mode_switch_combo.set_model(wayround_i2p.pyabber.l10n.MODE_LIST)
    ...
    def _combo_get_active(self):
        ...
        if res != -1:
            ret = wayround_i2p.pyabber.l10n.MODE_LIST[res][0]
    ...
    def get_mode_lang_switch_status(self):
        ...
        if active != -1:
            ...
            if self._mode == 'message':
                ...
                res = wayround_i2p.pyabber.l10n.LANG_RE.match(active_text)
                if res != None:
                    lang = res.group('lang')
                    if lang == None:
                        lang = ''
