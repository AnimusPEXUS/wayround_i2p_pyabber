...
class RegistrationWidget:
    ...
    def set_form(self, form, original_stanza):
        ...
        oob = form.get_oob()
        if oob != None:
            self._oob = wayround_i2p.pyabber.oob.OOBField(oob)
            _f = Gtk.Frame()
        ...
        if xdata != None:
            self._xdata = wayround_i2p.pyabber.xdata.XDataFormWidget(
                self._controller,
                xdata,
                original_stanza
                )
    ...
    def get_query(self):
        ...
        form = wayround_i2p.xmpp.registration.Query()
...
'UNREGISTERED' is valid value for unreg sequences."""
    ...
    def get_registration_form(self):
        ...
        res, stanza = wayround_i2p.xmpp.registration.get_query(
            f,
            t,
    ...
    def _on_send_button_clicked(self, widget):
        ...
        res = wayround_i2p.xmpp.registration.set_query(
            f,
            t,
            form,
            self._controller.client.stanza_processor,
    ...
    def _on_remove_button_clicked(self, widget):
        t, f = self.get_to_and_from()
        res = wayround_i2p.xmpp.registration.unregister(
            f,
            t,
            self._controller.client.stanza_processor,
            True
