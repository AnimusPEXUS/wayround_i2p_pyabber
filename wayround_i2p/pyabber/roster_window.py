...
import wayround_i2p.pyabber.roster_widget
...
#        self._message_client = message_client
        ...
        server_jid_widget = wayround_i2p.pyabber.jid_widget.JIDWidget(
            controller,
            controller.roster_storage,
        ...
        for i in [
            ...
            _rw = wayround_i2p.pyabber.roster_widget.\
                RosterWidget(
                    self._controller,
        ...
        window.connect(
            'delete-event', wayround_i2p.utils.gtk.hide_on_delete
            )
