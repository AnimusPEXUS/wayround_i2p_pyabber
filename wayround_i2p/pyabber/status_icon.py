...
class MainStatusIconMenu:
    ...
    def add_connection_menu(self, name, menu):
        ...
        if not isinstance(menu, wayround_i2p.pyabber.ccc.ConnectionStatusMenu):
            raise ValueError(
                "`menu' must be wayround_i2p.pyabber.ccc.ConnectionStatusMenu"
                )
...
class MainStatusIcon:
    ...
    def __init__(self, main):
        ...
        icon.set_from_pixbuf(wayround_i2p.pyabber.icondb.get('main'))
