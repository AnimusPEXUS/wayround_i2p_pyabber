...
import wayround_i2p.pyabber.ccc
import wayround_i2p.pyabber.contact_popup_menu
import wayround_i2p.pyabber.icondb
...
class JIDWidget:
    ...
    def __init__(
        ...
        self._menu = \
            wayround_i2p.pyabber.contact_popup_menu.ContactPopupMenu(
                controller
                )
        ...
        self._roster_storage_listener_idle = \
            wayround_i2p.utils.gtk.to_idle(self._roster_storage_listener)
    ...
    def _set_available(self, value):
        if value:
            self._available_i.set_from_pixbuf(
                wayround_i2p.pyabber.icondb.get('contact_available')
                )
            self._available_i.set_tooltip_text('Available')
        else:
            self._available_i.set_from_pixbuf(
                wayround_i2p.pyabber.icondb.get('contact_unavailable')
                )
    ...
    def _set_show(self, value):
        ...
        self._show_i.set_from_pixbuf(
            wayround_i2p.pyabber.icondb.get('show_{}_10x10'.format(value))
            )
    ...
    def _set_subscription(self, value):
        ...
        self._subscription_i.set_from_pixbuf(
            wayround_i2p.pyabber.icondb.get('subscription_{}'.format(value))
            )
...
class MUCRosterJIDWidgetMenu:
    ...
    def __init__(self, controller, muc_roster_storage):
        ...
        self._on_edit_entity_activated_idle = \
            wayround_i2p.utils.gtk.to_idle(self._on_edit_entity_activated)
        ...
        self._on_mini_edit_entity_activated_idle = \
            wayround_i2p.utils.gtk.to_idle(self._on_mini_edit_entity_activated)
    ...
    def _on_mini_edit_entity_activated(self, mi):
        room_resource_jid = wayround_i2p.xmpp.core.JID.new_from_str(
            self._bare_or_full_jid
            )
        ...
        if room_resource_jid_true_jid is not None:
            target_jid = wayround_i2p.xmpp.core.JID.new_from_str(
...
class MUCRosterJIDWidget:
    ...
    def __init__(self, room_bare_jid, nick, controller, muc_roster_storage):
        ...
        with self._lock:
            ...
            self._on_storage_actions_idle = \
                wayround_i2p.utils.gtk.to_idle(self._on_storage_actions)
            ...
            self._on_storage_rename_idle = \
                wayround_i2p.utils.gtk.to_idle(self._on_storage_rename)
    ...
    def reload_data(self, item=None):
        ...
        with self._lock:
            ...
            self._user_pic.set_from_pixbuf(
                wayround_i2p.pyabber.icondb.get('q_10x10')
                )
    ...
    def _set_affiliation(self, value):
        ...
        self._affiliation_icon.set_from_pixbuf(
            wayround_i2p.pyabber.icondb.get('aff_{}_10x10'.format(value))
            )
    ...
    def _set_role(self, value):
        ...
        self._role_icon.set_from_pixbuf(
            wayround_i2p.pyabber.icondb.get('role_{}_10x10'.format(value))
            )
...
class GroupChatTabWidget:
    ...
    def __init__(
        ...
        with self._lock:
            ...
            self._menu = \
                wayround_i2p.pyabber.muc.MUCPopupMenu(
                    controller
                    )
