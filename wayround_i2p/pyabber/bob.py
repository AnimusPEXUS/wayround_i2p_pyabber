...
class BOBMgr:
    ...
    def get_data_by_cid(
        ...
        res = wayround_i2p.xmpp.bob.parse_cid(cid)
    ...
    def get_data(
        ...
        if stanza_with_bob_data != None:
            ...
            for i in bob_elements:
                if wayround_i2p.utils.lxml.is_lxml_tag_element(i):
                    ...
                    i_cid = wayround_i2p.xmpp.bob.parse_cid(i.get('cid'))
                    ...
                    if i_cid == req_cid:
                        bob = wayround_i2p.xmpp.bob.Data.new_from_element(i)
                        ret = bob
                        break
        ...
        if ret == None:
            ...
            if res == None:
                ...
                self.request(
                    source_jid_obj,
                    wayround_i2p.xmpp.bob.format_cid(method, value)
                    )
    ...
    def request(self, source_jid_obj, cid):
        ...
        cir_req = wayround_i2p.xmpp.bob.Data(cid)
        ...
        if isinstance(res, wayround_i2p.xmpp.core.Stanza):
            ...
            if res.is_error():
                ...
                if bob == None:
                    ...
                    bob = wayround_i2p.xmpp.bob.Data.new_from_element(bob)
