...
import wayround_i2p.pyabber.profile
...
#        self._window.hide()
    ...
    def refresh_list(self):
        ...
        profiles = wayround_i2p.pyabber.profile.list_pfl(
        ...
        for i in profiles:
            ...
            tree.append([i, wayround_i2p.pyabber.icondb.get('profile')])
    ...
    def _on_new_clicked(self, button):
        ...
        if r['button'] == 'ok':
            ...
            res = wayround_i2p.pyabber.profile.open_pfl(
    ...
    def _on_delete_clicked(self, button):
        ...
        if i_len == 0:
            ...
            if r == Gtk.ResponseType.YES:
                ...
                profile = wayround_i2p.utils.path.join(
        ...
        if i_len == 0:
            ...
            if r['button'] == 'ok':
                ...
                self._main.set_profile(
                    wayround_i2p.pyabber.main.ProfileSession(
                        self._main,
                        wayround_i2p.pyabber.profile.open_pfl(
                            wayround_i2p.utils.path.join(
