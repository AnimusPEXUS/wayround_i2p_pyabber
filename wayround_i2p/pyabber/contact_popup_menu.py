...
class ContactPopupMenu:
    ...
    def __init__(self, controller):
        ...
        misco_menu = wayround_i2p.pyabber.disco.DiscoMenu(controller)
    ...
    def set(self, bare_or_full_jid):
        ...
        jid = wayround_i2p.xmpp.core.JID.new_from_str(bare_or_full_jid)
        self._jid = jid
    ...
    def _send_message_activate(self, menuitem):
        ...
        stanza.set_subject(
            [wayround_i2p.xmpp.core.MessageSubject("HI!")]
            )

        stanza.set_body(
            [wayround_i2p.xmpp.core.MessageBody("How are You?")]
            )
