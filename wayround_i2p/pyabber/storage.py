...
import wayround_i2p.utils.sqlalchemy
import wayround_i2p.xmpp.bob


class StorageDB(wayround_i2p.utils.db.BasicDB):
...
class Storage:
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.CONNECTION_PRESET_FIELDS = \
            wayround_i2p.utils.types.attrs_dict_to_object_same_names(
                wayround_i2p.utils.sqlalchemy.get_column_names(
...
#                )
    ...
    def get_connection_preset_by_name(self, name):
        ...
        with self._lock:
            ...
            try:
                ...
                if ret is not None:
                    res = {}
                    wayround_i2p.utils.types.attrs_object_to_dict(
    ...
    def set_connection_preset(self, name, preset):
        ...
        with self._lock:
            ...
            try:
                ...
                wayround_i2p.utils.types.attrs_dict_to_object(
        ...
        with self._lock:
            ...
            try:
                ...
                if _mode == 'get' and ret is not None:
                    res = wayround_i2p.xmpp.bob.Data(
                        wayround_i2p.xmpp.bob.format_cid(method, sum_val)
                        )
    ...
    def add_bob_data(self, date, bob):
        ...
        if not isinstance(bob, wayround_i2p.xmpp.bob.Data):
            raise ValueError("`bob' must be wayround_i2p.xmpp.bob.Data")
